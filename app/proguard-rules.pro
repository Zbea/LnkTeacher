...
-keep class com.bll.lnkteacher.utils.**{*;}
-keep class com.bll.lnkteacher.mvp.** {*;}
-keep class com.bll.lnkteacher.net.** {*;}
-keep class com.htfy.** { *; }
-keep class com.bll.lnkteacher.MethodManager{*;}
-keep class com.bll.lnkteacher.DataBeanManager{*;}
