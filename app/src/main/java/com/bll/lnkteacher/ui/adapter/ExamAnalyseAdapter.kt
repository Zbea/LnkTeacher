...
class ExamAnalyseAdapter(layoutResId: Int, private val scoreType:Int,private val module:Int, data: List<AnalyseItem>?) : BaseQuickAdapter<AnalyseItem, BaseViewHolder>(layoutResId, data) {
    ...
    override fun convert(helper: BaseViewHolder, item: AnalyseItem) {
        ...
        helper.setGone(R.id.tv_score,scoreType==1)
