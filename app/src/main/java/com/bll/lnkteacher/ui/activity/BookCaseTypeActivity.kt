...
class BookCaseTypeActivity: BaseActivity(){
    ...
    override fun initView() {
        ...
        mAdapter?.setOnItemClickListener { adapter, view, position ->
            ...
            intent.putExtra("book_id",books[position].id.toInt())
    ...
    private fun onLongClick(): Boolean {
        val dialogManager= BookManageDialog(this,0,book!!)
    ...
    //删除书架书籍
    private fun delete(){
        CommonDialog(this).setContent("确认删除该书籍？").builder().setDialogClickListener(object :
