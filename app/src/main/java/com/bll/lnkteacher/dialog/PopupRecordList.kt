...
import com.bll.lnkteacher.manager.RecordDaoManager
...
class PopupRecordList(var context: Context, var view: View) {
    ...
    private fun fetchData(){
        ...
        val total = RecordDaoManager.getInstance().queryAllList().size
