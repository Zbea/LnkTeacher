 ...
 * 多选弹框
 */
class PopupCheckList(val context:Context, val list:MutableList<PopupBean>, val view: View, val width:Int, val yoff:Int) {
    ...
    fun builder(): PopupCheckList{
        ...
        mPopupWindow = PopupWindow(context).apply {
            ...
            if (this@PopupCheckList.width!=0){
                width=this@PopupCheckList.width
            }
        }
